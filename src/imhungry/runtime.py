...
from .providers import BedrockNutritionProvider, WebMenuProvider
...
def app_factory():
    ...
    services = NutritionService(repository, provider=WebMenuProvider())
    # Bedrock estimation remains a separate provider selected by estimate_food;
